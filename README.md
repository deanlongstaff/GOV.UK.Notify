...
[![PowerShell Gallery Version](https://img.shields.io/powershellgallery/v/GovUKNotify)](https://www.powershellgallery.com/packages/GovUKNotify)
[![PowerShell Gallery Downloads](https://img.shields.io/powershellgallery/dt/GovUKNotify)](https://www.powershellgallery.com/packages/GovUKNotify)
...
```powershell
Install-Module -Name GovUKNotify -Scope CurrentUser
```

## Quick start

```powershell
Import-Module GovUKNotify
...
Import-Module ./src/GovUKNotify/GovUKNotify.psd1 -Force
```
